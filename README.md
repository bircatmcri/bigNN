...
<p align="justify">
<strong>[1]</strong> Ahmad P. Tafti, Ehsun Behravesh, Mehdi Assefi, Eric LaRose, Jonathan Badger, John Mayer, AnHai Doan, David Page, Peggy Peissig. 2017. <i>bigNN: an open-source sentence classifier using big data neural network architecture</i>. <strong>IEEE BIG DATA 2017.</strong> (Under Review)
</p>
